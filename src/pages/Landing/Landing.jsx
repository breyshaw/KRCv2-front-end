  ...
  return (
    <main className={styles.container}>
      ...
      <div className='card'>
        ...
        <br />
        <a className="align-self-center" href="/items">
          <button className='btn btn-primary'>Click here to start browsing</button>
        </a>
        ...
        <br />          
          ...
          <div class="fb-page align-self-center" data-href="https://m.facebook.com/KatieRayneCreations" data-tabs="timeline" data-width="540" data-height="360" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://m.facebook.com/KatieRayneCreations" class="fb-xfbml-parse-ignore"><a href="https://m.facebook.com/KatieRayneCreations">Katie Rayne Creations</a></blockquote></div>
        {user ? '' :
